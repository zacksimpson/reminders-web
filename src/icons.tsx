...
export function TodayIcon({ size = 23 }: { size?: number }) {
  return (
    <svg width={size} height={size * (85.28 / 86.06)} viewBox="0 0 86.06 85.28">
...
/** User-supplied icon (not from the phone app) for the web-only Add Task nav item. */
export function AddTaskIcon({ size = 23 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 47 47">
      <path
        d="M24.9276 10.149H22.0167V22.09H10.0757V25.0009H22.0167V36.9418H24.9276V25.0009H36.8685V22.09H24.9276V10.149Z"
        fill="#fff"
      />
      <path
        d="M40.0455 40.1031C36.7592 43.378 32.5762 45.6057 28.0248 46.5049C23.4733 47.4041 18.7574 46.9344 14.4727 45.1553C10.1879 43.3761 6.52645 40.3672 3.95059 36.5085C1.37473 32.6499 0 28.1145 0 23.475C0 18.8356 1.37473 14.3001 3.95059 10.4415C6.52645 6.5828 10.1879 3.5739 14.4727 1.79474C18.7574 0.015586 23.4733 -0.454053 28.0248 0.445132C32.5762 1.34432 36.7592 3.572 40.0455 6.84689H40.1237C42.3071 9.03294 44.0375 11.6285 45.2156 14.4847C46.3937 17.3409 46.9964 20.4016 46.9892 23.4913C46.9819 26.5809 46.3648 29.6387 45.1732 32.4894C43.9817 35.34 42.2391 37.9274 40.0455 40.1031ZM9.18369 9.19439C6.33733 12.0393 4.39861 15.6644 3.61274 19.6112C2.82686 23.558 3.22914 27.6493 4.7687 31.3675C6.30825 35.0856 8.91592 38.2637 12.2619 40.4997C15.6078 42.7357 19.5417 43.9292 23.566 43.9292C27.5903 43.9292 31.5243 42.7357 34.8702 40.4997C38.2162 38.2637 40.8238 35.0856 42.3634 31.3675C43.9029 27.6493 44.3052 23.558 43.5193 19.6112C42.7335 15.6644 40.7947 12.0393 37.9484 9.19439C34.1333 5.38124 28.96 3.23921 23.566 3.23921C18.172 3.23921 12.9988 5.38124 9.18369 9.19439Z"
        fill="#fff"
      />
    </svg>
  );
...
export function CheckboxIcon({ checked, size = 20 }: { checked: boolean; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 84 84">
      ...
      {checked && <circle cx="42" cy="42" r="35.375" fill="#fff" />}
    </svg>
  );
}
...
export function DeleteIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32">
      ...
      <path d="M0 3.46908L12.1169 15.5859L0 27.7028L3.46908 31.1719L15.5859 19.055L27.7028 31.1719L31.1719 27.7028L19.055 15.5859L31.1719 3.46908L27.7028 0L15.5859 12.1169L3.46908 0L0 3.46908ZM15.5859 13.3825L27.7028 1.26561L29.9063 3.46908L17.7894 15.5859L29.9063 27.7028L27.7028 29.9063L15.5859 17.7894L3.46908 29.9063L1.26561 27.7028L13.3825 15.5859L1.26561 3.46908L3.46908 1.26561L15.5859 13.3825Z" fill="#fff" />
    </svg>
  );
}
...
/** MaterialIcons "link" glyph, used for the linkified-title chip. */
